...
import { customers } from "@/data/placeholderData";
...
const Customers = () => {
  ...
  const { quotes, customers: contextCustomers, addCustomer } = context;

  // Replace hardcoded customers data
  ...
  const getCustomerQuoteInfo = (customerId: string) => {
    const customerQuotes = quotes.filter((q) => q.customerName === customerId);
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">
                        Quotes:{" "}
                        <span className="font-semibold">{quoteInfo.count}</span>
                      </span>
                      <span className="text-gray-600">
                        Value:{" "}
                        <span className="font-semibold">{quoteInfo.value}</span>
                      </span>
                    </div>
                  </div>
                </Card>
