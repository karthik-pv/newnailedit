...
const Settings = () => {
  ...
  const businessStats = {
    totalQuotes: allData.summary.totalQuotes,
    activeProjects: allData.summary.activeProjects,
    totalRevenue: allData.summary.totalRevenue,
    activeCustomers: allData.summary.activeCustomers,
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          {settingSections.map((section, index) => (
            <Card
              key={section.title}
              className="glass p-6 animate-slide-up"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Receive updates about quotes and jobs via email
                  </p>
                </div>
                <Switch
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    $29/month • Next billing: Jan 15, 2025
                  </p>
                </div>
                <Button variant="outline" className="glass-card border-0">
                  Manage Plan
