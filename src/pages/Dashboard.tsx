...
const Dashboard = () => {
  ...
  const { customers, quotes, scheduledJobs } = context;
        ...
        <div className="p-4 lg:p-6">
          ...
          <div className="mt-6 lg:mt-8">
            <Card className="glass-card p-3 lg:p-4">
              ...
              <Button size="sm" className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white text-xs lg:text-sm" onClick={() => navigate('/upgrade')}>
                Upgrade Now
              </Button>
            </Card>
          </div>
        ...
        <main className="p-3 lg:p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4 lg:space-y-6">
              ...
              {/* Upcoming Schedule */}
              <Card className="glass p-4 lg:p-6">
                <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-4 lg:mb-6">Upcoming Schedule</h3>
                <div className="space-y-3 lg:space-y-4">
                  {scheduledJobs.slice(0, 3).map((job) => (
                    <div key={job.id} className="glass-card p-3 lg:p-4 hover:glass transition-all duration-200">
                      <div className="flex items-center justify-between">
                        <div>
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium text-gray-800">{job.date.toLocaleDateString()}</p>
