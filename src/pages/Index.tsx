...
const Index = () => {
  ...
  const features = [
    {
      ...
      description:
        "Generate professional quotes instantly with our advanced AI",
  ...
  // Replace any hardcoded stats with imported data
  const heroStats = [
    { label: "Active Projects", value: allData.summary.activeProjects },
    { label: "Happy Customers", value: allData.summary.activeCustomers },
    {
      label: "Total Revenue",
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center">
        <div className="text-center animate-fade-in">
          ...
          <p
            className="text-xl text-slate-300 mb-8 animate-slide-up"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 relative overflow-hidden">
      ...
      <div
        className="absolute top-40 right-20 w-96 h-96 bg-cyan-400/10 rounded-full blur-3xl floating"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute bottom-20 left-40 w-80 h-80 bg-purple-400/10 rounded-full blur-3xl floating"
        ...
        <div className="space-y-8 animate-fade-in">
          <div className="space-y-6">
            ...
            <p className="text-xl text-slate-300 leading-relaxed max-w-lg">
              Generate professional quotes instantly with AI, manage customers
              effortlessly, and grow your fencing business like never before.
            </p>
          </div>
